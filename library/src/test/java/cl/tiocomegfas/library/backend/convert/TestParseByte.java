...
public class TestParseByte {

    static ParseByte parser;
    ...
    @Test
    public void parseString() throws UtilityException {
        byte respuesta = parser.parse("120");
        byte esperado = 120;
    ...
    public void parseInt(){
        byte respuesta = parser.parse(100);
        byte esperado = 100;
        assertEquals(esperado,respuesta);
    }

    @Test(expected = UtilityException.class)
    public void parseIntException(){
        parser.parse(10.5);
    }
